        ...
        children: [
          Row(
            children: const [
              ...
              Expanded(child: Text('title', style:  TextStyle(height: 3.0, fontSize: 15.2, fontWeight: FontWeight.bold,))),
              Expanded(child: Text('memo', style:  TextStyle(height: 3.0, fontSize: 15.2, fontWeight: FontWeight.bold,))),
            ]
          ),
